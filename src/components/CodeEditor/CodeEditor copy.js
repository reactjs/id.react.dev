...
// Ganti unicode menjadi text untuk bahasa lainnya
...
class CodeEditor extends Component {
  ...
  render() {
    ...
    if (showBabelErrorMessage) {
      errorMessage = ( < span >
        <
        i > Babel < /i> tidak bisa dimuat. <
        br / >
        <
        br / >
        This can be caused by an ad blocker.If you 're using one, consider
        adding reactjs.org to the whitelist so the live code examples will work. < /span>
      );
    } else if (error != null) {
